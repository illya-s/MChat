...
class Room(models.Model):
    ...
    class Types(models.TextChoices):
        ...
        GROUP		 = "group", "Group"
        SUPPER_GROUP = "supergroup", "SuperGroup"

        CHAT		 = "chat", "Chat"
        SUPPER_CHAT	 = "superchat", "SuperChat"

    hash = models.CharField(max_length=64, unique=True, editable=False)

    name = models.CharField(max_length=255)
    type = models.CharField(max_length=50, choices=Types.choices, default=Types.ROOM)
    ...
    def save(self, *args, **kwargs):
        if not self.hash:
            ...
            self.hash = hashlib.sha256(unique_id.encode()).hexdigest()
